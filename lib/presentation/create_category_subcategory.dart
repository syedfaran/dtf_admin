        ...
        child: ConstrainedBox(
          ...
          child: Column(
            children: [
              ...
              ///
              Form(key: _formKeyTwo,child: Column(
         //      crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const KText(AppString.addSubCategory, fontSize: 34.0, fontWeight: FontWeight.bold),
                    ...
                    builder: (_,value,child) {
                      return Center(
                        child: Padding(
                          padding: const EdgeInsets.symmetric(vertical: 16.0),
                          child: ElevatedButton(
                            onPressed:  !(value.mainCategory.isEmpty&&value.mainCategory.isEmpty)?() async {
